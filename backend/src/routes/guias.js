...
const { criarGuiaSchema, atualizarGuiaSchema, statusGuiaSchema } = require('../schemas/guiaSchema');
...
// Criar Guia
router.post('/', autenticar, autorizar('medico'), validar(criarGuiaSchema), async (req, res) => {
  try {
